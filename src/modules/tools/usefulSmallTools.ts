...
between browser sessions but are private to this application.`,
  parameters: {
    ...
    properties: {
      action: {
        type: 'string',
        enum: ['save', 'load', 'list', 'delete', 'exists'],
      ...
      filename: {
        type: 'string',
        description: 'The name of the file to save, load, or check',
      },
      content: {
        type: 'string',
...
export const useFullSmallTools = [openMeteoWeatherTool, opfsStorageTool]
