  ...
  <div class="column q-gutter-xs items-stretch content-stretch fit">
    ...
    <div class="row q-gutter-xs items-stretch">
        ...
        <q-card>
          <q-card-section>
            ...
            <q-list dense separator bordered>
              <q-item
                href="https://github.com/xyntopia/vexvault#readme"
                target="_blank"
                >-> Vexvault documentation/github</q-item
              >
              <q-item
                href="https://codepen.io/xyntopia/pen/zYMLRWN"
                target="_blank"
                >-> Vexvault iFrame integration example</q-item
              >
              <q-item
                href="https://github.com/Xyntopia/vexvault/blob/main/tutorial_vexvault_iframe.md"
                target="_blank"
                >-> Vexvault iFrame integration tutorial</q-item
              >
              <q-item href="https://www.vexvault.com" target="_blank"
                >-> Vexvault homepage</q-item
              >
              <q-item href="https://www.xyntopia.com" target="_blank"
                >-> Xyntopia homepage</q-item
              >
            </q-list>
          </q-card-section>
        </q-card>
      ...
      <div class="col-6">
        <q-card class="fit">
          <q-card-section>
            This is the uploader widget, you can add it to your app by
            integrating it with iframe (<a
              href="https://github.com/Xyntopia/vexvault/blob/main/tutorial_vexvault_iframe.md"
              target="_blank"
              >tutorial</a
            >).
            ...
            <q-list dense separator bordered>
              <q-item clickable @click="resetDb">
                <q-item-section avatar>
                  <q-icon :name="matDeleteForever" color="red">
    ...
    <div class="row">
      <q-card class="col-auto">
        <q-card-section>
          <q-btn :icon="matChat" label="Chat with the store" to="chat" />
        </q-card-section>
      </q-card>
      <q-card class="col">
        <q-card-section>
...
import { matChat, matDeleteForever } from '@quasar/extras/material-icons';
