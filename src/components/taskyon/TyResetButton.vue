    ...
    <q-dialog v-model="showResetDialog">
      <q-card>
        ...
        <q-card-section class="q-pt-none">
          <p v-if="mode === 'settings'">
            <strong>Warning:</strong> This operation will permanently delete all
            Taskyon chat data. This action cannot be undone.
          </p>
          <p v-else-if="mode === 'tasks'">
          ...
          <p v-else>
            <strong>Warning:</strong> This operation will permanently delete all
            taskyon settings including chat data & app settings.
          </p>
          <p>
            Before proceeding, please make sure you have a backup of the
            settings. You can backup your data here:
            <q-btn
              dense
              flat
              color="secondary"
