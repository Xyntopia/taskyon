      ...
      <q-card flat bordered>
        ...
        <q-card-section class="q-gutter-md">
          <div class="row items-center">
            <div class="q-pr-md">
              Select which API to use. At least one API key needs to be specified below.
            </div>
            <ApiSelect v-model="state.llmSettings.selectedApi" />
          </div>
          <div>
            Activate API by specifying an API key (taskyon API keys can be generated by a registered
            user here:
