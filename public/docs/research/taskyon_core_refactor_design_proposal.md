...
- `sandboxed-core-protocol-design.md`, which defines the protocol-first core and host boundary;
- `taskyon_runtime_storage_concept.md`, which defines `StorageClient` and storage services as the
  durable runtime boundary;
- `taskyon_encrypted_storage_objects.md`, which defines encrypted durable object storage.
