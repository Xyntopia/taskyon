...
const COMPARE_ARTIFACT_DIR = join(PROJECT_ROOT, 'packages/modelica/compare')
...
Usage:
  node packages/modelica/modelica_compare_cli.mjs run [options]
  node packages/modelica/modelica_compare_cli.mjs baseline-diff [options]
  node packages/modelica/modelica_compare_cli.mjs baseline-update [options]
  node packages/modelica/modelica_compare_cli.mjs probe-compile --model <qualified.name> [options]
  node packages/modelica/modelica_compare_cli.mjs probe-source --model <qualified.name> --source-file <path> [options]
  node packages/modelica/modelica_compare_cli.mjs probe-solve --model <qualified.name> [options]
...
Options:
  ...
  --solver-file <path>                 JS solver file (default: packages/modelica/simulateModel.js)
  --template-file <path>               Jinja template file (default: packages/modelica/javascript.jinja)
  --omc-wrapper <path>                 OMC podman wrapper (default: packages/modelica/scripts/omc-via-podman.sh)
...
function parseArgs(argv) {
  const options = {
    ...
    probeOutputFile: '',
    solverFile: join(PROJECT_ROOT, 'packages/modelica/simulateModel.js'),
    templateFile: join(PROJECT_ROOT, 'packages/modelica/javascript.jinja'),
    omcWrapper: join(PROJECT_ROOT, 'packages/modelica/scripts/omc-via-podman.sh'),
...
function formatCompareReport(summary) {
  ...
  const lines = [
    ...
    'NOTE: AI/debug agents should follow the testing strategy in packages/modelica/README.md',
