...
export namespace dm {
  ...
  export namespace DirectMessage {
    ...
    export const decode = (
      ...
      opts?: DecodeOptions<DirectMessage>,
    ): DirectMessage => {
        ...
        _codec = message<DirectMessageRequest>(
          ...
          (reader, length, opts = {}) => {
            ...
            while (reader.pos < end) {
              ...
              switch (tag >>> 3) {
                case 1: {
                  obj.metadata = dm.Metadata.codec().decode(
                    reader,
                    reader.uint32(),
                    opts.limits?.metadata !== undefined
              ...
              switch (tag >>> 3) {
                case 1: {
                  obj.metadata = dm.Metadata.codec().decode(
                    reader,
                    reader.uint32(),
                    opts.limits?.metadata !== undefined ? { limits: opts.limits.metadata } : {},
                  )
                  break
                }
                case 2: {
