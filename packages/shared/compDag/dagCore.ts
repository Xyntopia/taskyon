...
// Node code hash placeholder (in real system: hash of source/bundle of this node)
      ...
      study: async (opts?: StudyOptions, ctx?: NodeContext, engineConfig?: EngineConfig) => {
        ...
        for (const patch of variableRuns) {
          ...
          for (const combo of combinations) {
            ...
            await runCombo(validatedBase, combo)
          }
        }
